...
rem set FO_FILE=C:\GP\run\test\test.fo
...
rem %JAVA_HOME%\java -Xms128M -Xmx128M transformXSLT C:\GP\run\%RUN_DATE%\%3.xml C:\GP\run\test\test.xsl %FO_FILE% %4
echo %JAVA_HOME%\java -Xms128M -Xmx128M transformXSLT C:\GP\run\%RUN_DATE%\%3.xml C:\GP\xsl\wk.xsl %FO_FILE% %4
%JAVA_HOME%\java -Xms128M -Xmx128M transformXSLT C:\GP\run\%RUN_DATE%\%3.xml C:\GP\xsl\wk.xsl %FO_FILE% %4
...
echo USAGE:
echo.
echo gen MMDD YYYY "Excel File" versionNumber
echo.
