							        ...
							        <fo:table>
							            ...
							            <fo:table-body>
							                ...
							                <fo:table-row height="3in">
							                    <fo:table-cell>
							                        <fo:block margin-top="0.5in"><xsl:value-of select="DateOnMailPiece"/></fo:block>
							                        <fo:block margin-top="0.378in"><xsl:value-of select="SoldToName"/></fo:block>
							                        <fo:block><xsl:value-of select="ShipToFirstName"/>&#160;<xsl:value-of select="ShipToLastName"/> </fo:block>
							                        <fo:block><xsl:value-of select="ShipToAddress"/></fo:block>
							                        <fo:block><xsl:value-of select="ShipToAddress2"/></fo:block>
							                        <fo:block><xsl:value-of select="ShipToCity"/>&#160;<xsl:value-of select="ShipToState"/>&#160;<xsl:value-of select="ShipToZip"/></fo:block>
							                    </fo:table-cell>
...
<!-- fold line 2 -->
							                    	...
							                    	<fo:block>
																			Your user name is: <xsl:value-of select="ShipToEMAddress"/>
							                    	</fo:block>
				                            <fo:block margin-top=".15in" 
				                            	...
				                            	background="black">RENEWAL OPTIONS:</fo:block>
														        ...
														        <fo:block margin-top="0.02in">
														        	<fo:inline font-family="FiraSans-mediumitalic">Questions regarding this renewal or want to cancel?</fo:inline> Contact your solution consultant:<fo:block><xsl:value-of select="RepName"/>; <xsl:value-of select="RepPhone"/>, <xsl:value-of select="RepEMAddress"/></fo:block>
														        </fo:block>
							                   ...
							                   <fo:table-row height="3in">
							                   	<fo:table-cell>
							                        ...
							                        <fo:block font="12pt FiraSans-book" margin-top="1in">
								                        <fo:block ><xsl:value-of select="SoldToName"/></fo:block>
								                        <fo:block><xsl:value-of select="ShipToFirstName"/>&#160;<xsl:value-of select="ShipToLastName"/> </fo:block>
								                        <fo:block><xsl:value-of select="ShipToAddress"/></fo:block>
								                        <fo:block><xsl:value-of select="ShipToAddress2"/></fo:block>
								                        <fo:block><xsl:value-of select="ShipToCity"/>&#160;<xsl:value-of select="ShipToState"/>&#160;<xsl:value-of select="ShipToZip"/></fo:block>
...
<!-- fold line 3 -->
							                   			<fo:block margin-top=".25in" margin-left="-.75in" font="6pt FiraSans-mediumitalic">DETACH THIS PORTION AND MAIL THIS ORDER FORM IN THE REPLY ENVELOPE PROVIDED.</fo:block>
							                   		</fo:block>
							                   	</fo:table-cell>
							                   	<fo:table-cell>
																			<fo:block margin-top=".1in" font="10pt FiraSans-bold">YES! Renew my subscription to:</fo:block>
																        ...
																        <fo:table>
																            ...
																            <fo:table-body font-family="FiraSans-bold">
																                <fo:table-row background="#ECEDEE" line-height=".3125in">
																                    ...
																                    <fo:table-cell><fo:block>$xx.xx</fo:block></fo:table-cell>
														                   </fo:table-row>
																                <fo:table-row background="#ECEDEE" line-height=".3125in">
																                    <fo:table-cell border-top="0.2pt solid #AFB1B4" border-bottom="0.2pt solid #AFB1B4"><fo:block line-height=".1in" margin-left=".1in" margin-top=".1in" height=".015in" width=".1in" border="0.5pt solid black">&#160;</fo:block></fo:table-cell>
																                    <fo:table-cell border-top="0.2pt solid #AFB1B4" border-bottom="0.2pt solid #AFB1B4"><fo:block>CCH Answer<fo:inline font-family="FiraSans-bolditalic">Connect!</fo:inline></fo:block></fo:table-cell>
																                    <fo:table-cell border-top="0.2pt solid #AFB1B4" border-bottom="0.2pt solid #AFB1B4"><fo:block>$xx.xx</fo:block></fo:table-cell>
														                   </fo:table-row>
																                <fo:table-row background="#ECEDEE" line-height=".3125in">
																                    <fo:table-cell><fo:block line-height=".1in" margin-left=".1in" margin-top=".1in" height=".015in" width=".1in" border="0.5pt solid black">&#160;</fo:block></fo:table-cell>
																                    <fo:table-cell><fo:block>CCH Answer<fo:inline font-family="FiraSans-bolditalic">Connect!</fo:inline></fo:block></fo:table-cell>
																	        ...
																	        <fo:table border="0.5pt solid black" >
																	            ...
																	            <fo:table-body>
																	                ...
																	                <fo:table-row text-align="center" line-height="0.3125in" font="8pt FiraSans-book" >
																	                    <fo:table-cell>
																												<fo:block><xsl:value-of select="PayerNum"/></fo:block>
																											</fo:table-cell>
																	                    <fo:table-cell border-right="0.5pt solid black" border-left="0.5pt solid black">
																												<fo:block><xsl:value-of select="ContractNum"/></fo:block>
																											</fo:table-cell>
																	                    <fo:table-cell>
																												<fo:block><xsl:value-of select="EndDate"/></fo:block>
																											</fo:table-cell>
																									</fo:table-row>
																							</fo:table-body>
																					</fo:table>
																					<fo:block font="6pt FiraSans-book" text-align="right" margin-top=".025in">DTN #</fo:block>
																				</fo:block>
																	</fo:table-cell>
																</fo:table-row>
